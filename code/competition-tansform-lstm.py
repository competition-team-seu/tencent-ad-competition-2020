...
def comprehensive_model_conv_v12(emb1, emb2, emb3, emb4, emb6, num_features_input):
    ...
    cnn1d_layer = Conv1D(180, kernel_size=2, padding="valid", kernel_initializer="he_uniform")
    ...
    x1_all = concatenate([att_1, merged_1, merged_1_avg, cnn1, att_2, merged_2, merged_2_avg, cnn2])
    ...
    merged_2 = Lambda(lambda x: K.max(x, axis=1), output_shape=(128,))(semantic)
    merged_2_avg = Lambda(lambda x: K.mean(x, axis=1), output_shape=(128,))(semantic)
    x2_all = concatenate([att_1, merged_1, merged_1_avg, cnn1, att_2, merged_2, merged_2_avg, cnn2])
    ...
    merged_2 = Lambda(lambda x: K.max(x, axis=1), output_shape=(128,))(semantic)
    merged_2_avg = Lambda(lambda x: K.mean(x, axis=1), output_shape=(128,))(semantic)
    x3_all = concatenate([att_1, merged_1, merged_1_avg, cnn1, att_2, merged_2, merged_2_avg, cnn2])
    ...
    merged_2 = Lambda(lambda x: K.max(x, axis=1), output_shape=(128,))(semantic)
    merged_2_avg = Lambda(lambda x: K.mean(x, axis=1), output_shape=(128,))(semantic)
    x4_all = concatenate([att_1, merged_1, merged_1_avg, cnn1, att_2, merged_2, merged_2_avg, cnn2])
    ...
    merged_2 = Lambda(lambda x: K.max(x, axis=1), output_shape=(128,))(semantic)
    merged_2_avg = Lambda(lambda x: K.mean(x, axis=1), output_shape=(128,))(semantic)
    x6_all = concatenate([att_1, merged_1, merged_1_avg, cnn1, att_2, merged_2, merged_2_avg, cnn2])
